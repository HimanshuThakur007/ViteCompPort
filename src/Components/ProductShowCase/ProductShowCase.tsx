...
<div id="mobile">
          ...
          <ProductCard_rightImg
            ...
            rtitle="Web Application Development"
            rtext="Excellent Softwares seems to be a leading Web Application development company with a comprehensive range of services. With a team of professionals, including UI/UX designers, web application developers, quality analysts, and marketers, "
...
<div id="Con">
          ...
          <ProductCard_rightImg
            ...
            rtext="We understand that every business is unique, and we believe that one software does not fit all. That’s why our approach to software solutions is focused on customization and Integerate design. We take the time to understand your industry and business processes,"
