...
<div className="container mt-3">
  <div className="row">
    <div className="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
      ...
      <p className='mt-3'>Infoserve empowers businesses with centralized control, powerful reporting, and user-friendly connectivity. It optimizes promotional strategies, ensures reliable data synchronization, and enables effective target setting, all leading to increased efficiency, growth, and success.</p>
    ...
    <div className="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
      <img src={info} className="img-fluid animated" alt=""/>
    </div>
  </div>
</div>
            ...
            <div className='row clearfix align-items-center justify-content-between'>
              ...
              <div className='col-lg-6 '>
                ...
                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <SmallProductCard cardTitle='Organization and coordination' src={i2} src2={li2} cardText='Implements a centralized control system that ensures efficient organization, with powerful reporting capabilities of all transactions distributor points and the company level' />
                                    </div>
